    ...
    task::spawn(async move {
        loop {
            ...
            if stats.http_tasks > 0 {
                log::info!("HTTP {} avg. {:.2}s, HTTPS {} avg. {:.2}s, FTP {} avg. {:.2}s, SSH {} avg. {:.2}s, TASK {} {} avg. {:.2}s, Spawn {}s",
                    ...
                    stats.dispatched_tasks, stats.task_time / stats.dispatched_tasks as f64,
                    stats.active_tasks, stats.spawn_time / stats.dispatched_tasks as f64,
                );
            }
        }
    });
